...
class  MetaHitPairs(object):
    ...
    def  __init__(self, fglob, rglob):
        
        parser = argparse.ArgumentParser("wrapper for megahit grouping forward and left reads")
        parser.add_argument('qiime_summary')
        parser.add_argument('-f','--fwd_glob', help = "wildcard for forward reads")
        parser.add_argument('-r','--rev_glob', help = "wildcard for reverse reads")
